...
export const fetchGetOperations = createAsyncThunk(
  'operations/get',
  async (params) => {
...
export const fetchGetTodayExpense = createAsyncThunk(
  'operations/todayExpense',
  async (params) => {
...
export const fetchGetTotalCash = createAsyncThunk(
  'operations/totalCash',
  async () => {
...
export const fetchGetMontExpense = createAsyncThunk(
  'operations/MonthExpense',
  async (params) => {
...
export const fetchGetMontRevenue = createAsyncThunk(
  'operations/MonthRevenue',
  async (params) => {
...
export const fetchGetYearExpense = createAsyncThunk(
  'operations/yearExpense',
  async () => {
