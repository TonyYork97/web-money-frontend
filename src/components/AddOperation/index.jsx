...
export const AddOperation = () => {
    ...
    useEffect(() => {
        ...
        setPaymentMethodsArr(dataPaymentMethods ? dataPaymentMethods.map(el => ({ value: el.title, label: <div className='flex gap-3 items-center'><img className='w-12' src={`http://localhost:8000${el.imageUrl}`} alt={el.title} /><h3>{el.title}</h3></div> })) : [])
