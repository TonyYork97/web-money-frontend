      ...
      <div className='grid grid-cols-2 gap-5'>
        {max ? (
          <div className='text-center'>
            ...
            <div className='relative font-bold'>
              <div className='absolute rounded-full shadow-redShadow border-white inline-block p-14 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-whiteOpacity'></div>
        ...
        {min ? (
          <div className='text-center'>
            ...
            <div className='relative font-bold'>
              <div className='absolute rounded-full shadow-greenShadow border-white inline-block p-14 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-whiteOpacity'></div>
