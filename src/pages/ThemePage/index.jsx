  ...
  return (
    <div>
      ...
      <div className='flex items-center gap-3 mb-3'>
        <div className=''>
          <input type="checkbox" hidden onChange={handleChangeTheme} checked={localStorage.getItem('theme') === 'dark' ? true : false} id="highload1" name="highload1" />
      ...
      <div className='flex items-center gap-3'>
        <div className=''>
          ...
          <label htmlFor="highload2" data-onlabel="on" data-offlabel="off"
            className={`${blur ? 'after:left-[23px] bg-mainGreen' : 'after:left-[1px] bg-bggBottom'} border border-darkBlack inline-block  relative w-[48px] h-[24px] rounded-[30px] cursor-pointer after:rounded-[50%] after:absolute after:top-[0px]  after:w-[22px] after:h-[22px] after:bg-white after:transition-all transition-all`}></label>
        </div>
