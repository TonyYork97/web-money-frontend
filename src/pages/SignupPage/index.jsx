...
export const SignupPage = () => {
  ...
  const name = register('name', {
    required: 'Имя должен иметь не менее 3 и не более 20 символов',
    minLength: 3,
    maxLength: 20,
  })
  const lastName = register('lastName', {
    required: 'Фамилия должен иметь не менее 3 и не более 20 символов',
    minLength: 3,
    maxLength: 20,
  })
  ...
  return (
    <AuthContainer>
      <div
        className={`w-full md:w-auto  mt-6 sm:mt-0 md:min-w-[448px] flex flex-col justify-center px-1 sm:px-7`}
      >
        ...
        <p className='text-xs text-center'>
          ...
          <Link
            to={links.login}
            className='underline underline-offset-2 hover:text-mainGreen transition-colors'
          >
            войдите
          </Link>
        </p>
